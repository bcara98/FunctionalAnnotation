...
# adapted from mmseqs_gff_from_blastX.py for use with mmseqs blastn search
...
for line in blastxfile:
        ...
        attributes = "Dbxref=PLSDB:" + str(sseqid) + ";Note= pident:" + pident + ", mismatch:" + mismatch + ', gapopen:' + gapopen + ', evalue:' + evalue
        ...
        g.write('>' + seqid + ':' + str(newstart) + '-' + str(newstop) + '; Db:' + args.source + '; PLSDB:' + sseqid + '\n')
        g.write(SEQ + '\n')
